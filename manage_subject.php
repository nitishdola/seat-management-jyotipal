...
if(!isset($_SESSION['Admin_ID'])){
	...
	// Get page data
	if($searchcriteria == '') {
		$query1 = "SELECT s.subject_id,s.subject_code,s.semester,d.full_name FROM $tableName s left outer join department d on d.department_id=s.department_id order by s.subject_id LIMIT $start, $limit";
	} else {
		$query1 = "SELECT * FROM $tableName $searchcriteria  order by subject_id LIMIT $start, $limit";
	}
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
		  ...
		  <!-- Form -->			
				...
				<legend> <span class="headbox">Manage Subject</span></legend>
               ...
               <table align="center" width="100%">
                ...
                <tr class="<?php if($i%2==1){echo "bg";} ?>">
					...
					<td><a href="subject.php?editID=<?php echo $data['subject_id']; ?>">Update</a></td>
