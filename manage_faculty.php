...
if(!isset($_SESSION['Admin_ID'])){
	...
	// Get page data
	if($searchcriteria == '') {
		$query1 = "SELECT * FROM $tableName order by faculty_id LIMIT $start, $limit";
	} else {
		$query1 = "SELECT * FROM $tableName $searchcriteria  order by faculty_id LIMIT $start, $limit";
	}
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
		  ...
		  <!-- Form -->			
				...
				<legend> <span class="headbox">Manage Faculty</span></legend>
...
<td><a href="faculty.php">Add Faculty</a></td>
					</tr>
                ...
                <tr class="<?php if($i%2==1){echo "bg";} ?>">
                    ...
                    <td><?php echo $data['name']; ?> </td> 
					 <td>
					 <a href="faculty.php?pagename=<?php echo substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1).'&'.$_SERVER['QUERY_STRING'];?>&editID=<?php echo $data['faculty_id']; ?>" title="Edit Faculty"> <img src="design/pencil.png" /> </a>
					<a href="#" title="Delete Faculty" onClick="javascript: var conf = confirm('Are You Want To Delete This Record?');if(conf){location.href='faculty.php?delID=<?php echo $data['faculty_id']; ?>';}" ><img src="design/ico-delete.gif" /></a></td>
				</tr>
                <?php $i++; } ?>
			</table>  
            </div>
