...
if(!isset($_SESSION['Admin_ID'])){
	...
	// Get page data
	if($searchcriteria == '') {
		$query1 = "SELECT r.room_id,r.name,d.full_name FROM $tableName r left outer join department d on d.department_id=r.department_id order by r.room_id LIMIT $start, $limit";
	} else {
		$query1 = "SELECT * FROM $tableName $searchcriteria  order by room_id LIMIT $start, $limit";
	}
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
		  ...
		  <!-- Form -->			
				...
				<legend> <span class="headbox">Manage Room</span></legend>
               ...
               <table align="center" width="100%">
                ...
                <tr class="<?php if($i%2==1){echo "bg";} ?>">
					...
					<td><?php echo $data['full_name']; ?> </td> 
					 <td><a href="room.php?editID=<?php echo $data['room_id']; ?>">Edit</a> </td> 
				</tr>
                <?php $i++; } ?>
			</table>  
            </div>
