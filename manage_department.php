...
if(!isset($_SESSION['Admin_ID'])){
	...
	$targetpage = "manage_department.php";
	$limit = 10; 
	...
	// Get page data
	if($searchcriteria == '') {
		$query1 = "SELECT * FROM $tableName order by department_id LIMIT $start, $limit";
	} else {
		$query1 = "SELECT * FROM $tableName $searchcriteria  order by department_id LIMIT $start, $limit";
	}
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
		  ...
		  <!-- Form -->			
				...
				<legend> <span class="headbox">Manage department</span></legend>
               ...
               <table align="center" width="100%">
                ...
                <tr class="<?php if($i%2==1){echo "bg";} ?>">
					...
					<td>
						<a href="manage_destination_image.php?id=<?php echo $data['department_id'] ?>" class="example1" title="Manage Images"> <img src="design/manage.png" width="25" height="25"/></a>
					</td> 
