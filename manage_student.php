...
if(!isset($_SESSION['Admin_ID'])){
	...
	// Get page data
	if($searchcriteria == '') {
		$query1 = "SELECT * FROM $tableName order by student_id LIMIT $start, $limit";
	} else {
		$query1 = "SELECT * FROM $tableName $searchcriteria  order by student_id LIMIT $start, $limit";
	}
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
		  ...
		  <!-- Form -->			
				...
				<legend> <span class="headbox">Manage Student</span></legend>
...
<td><a href="student.php">Add Student</a></td>
				...
				<tr>
				    <th width="5%">S.No.</th> 
                    <th width="65%">Name</th><th>Action</th>	 
                ...
                <tr class="<?php if($i%2==1){echo "bg";} ?>">
                    ...
                    <td><?php echo $data['name']; ?> </td> 
					 <td>
					 <a href="student.php?pagename=<?php echo substr($_SERVER["SCRIPT_NAME"],strrpos($_SERVER["SCRIPT_NAME"],"/")+1).'&'.$_SERVER['QUERY_STRING'];?>&editID=<?php echo $data['student_id']; ?>" title="Edit student"> <img src="design/pencil.png" /> </a>
					<a href="#" title="Delete student" onClick="javascript: var conf = confirm('Are You Want To Delete This Record?');if(conf){location.href='student.php?delID=<?php echo $data['student_id']; ?>';}" ><img src="design/ico-delete.gif" /></a></td>
				</tr>
                <?php $i++; } ?>
			</table>  
            </div>
